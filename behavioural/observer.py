class Subject(object): # Represent what being 'observed'
...
class TempViewer():
	...
	def update(self, subject): # Alert method that is invoked when notify() method in a concrete method is invoked
...
# Let's attach our observer to the first core
c1.attach(v1)
c1.attach(v2)
